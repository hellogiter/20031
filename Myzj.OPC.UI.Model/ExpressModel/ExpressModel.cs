...
namespace Myzj.OPC.UI.Model.ExpressModel
{
    ...
    public class ExpressInfoModelExt
    {
        ...
        public string LogiscticId { get; set; }
        public string LogiscticContent { get; set; }
        public string LogiscticContentShow { get; set; }
        public string LogiscticContentTitle { get; set; }
        public Nullable<int> LastStatus { get; set; }
        public string LastStatusDesc { get; set; }
        public string PushRequestStatus { get; set; }
        public string PushRequestMessage { get; set; }
        public Nullable<int> SubscribeStatus { get; set; }
        public string SubscribeStatusDesc { get; set; }
        ...
        public string SaltStr { get; set; }
        public Nullable<System.DateTime> RowCreateDate { get; set; }
        public string RowCreateDateDesc { get; set; }
        public Nullable<System.DateTime> RowModifyDate { get; set; }
        public string RowModifyDateDesc { get; set; }
        public Nullable<int> IsDel { get; set; }
        public Nullable<System.DateTime> CreateDate { get; set; }
        ...
        public string OrderStatusContentShow { get; set; }
        public string OrderStatusContentTitle { get; set; }
        /// <summary>
        /// 国际物流
        /// </summary>
        public string LogisticOuterContent { get; set; }
        public string LogisticOuterContentShow { get; set; }
        public string LogisticOuterContentTitle { get; set; }
        public string HandleSuggest { get; set; }
    }
    #endregion
