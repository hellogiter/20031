...
namespace Myzj.OPC.UI.Portal.Controllers.Express
{
    ...
    public class ExpressController : Controller
    {
        ...
        public ActionResult AccountStateMentIndex()
        {
            ...
            var begin = new DateTime(beforeMonth.Year, beforeMonth.Month, 1);
            var beforeMonthLastDay = begin.AddMonths(1).AddDays(-1);
            var end = new DateTime(beforeMonthLastDay.Year, beforeMonthLastDay.Month, beforeMonthLastDay.Day, 23, 59, 59);
            ViewBag.d1 = begin;
            ViewBag.d2 = end;
