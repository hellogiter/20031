...
(function () {
    var canvas = $G("J_brushBoard"),
        ...
        drawStep = [], //undo redo�洢
        drawStepIndex = 0; //undo redoָ��
    ...
    scrawl.prototype = {
        ...
        initOptions:function (options) {
            var me = this;
            me.originalState(options);//��ʼҳ��״̬
            me._buildToolbarColor(options.colorList);//��̬������ɫѡ�񼯺�

            me._addBoardListener(options.saveNum);//��ӻ��崦��
            me._addOPerateListener(options.saveNum);//���undo redo clearBoard����
            me._addColorBarListener();//�����ɫѡ����
            me._addBrushBarListener();//��ӻ��ʴ�С����
            me._addEraserBarListener();//�����Ƥ��С����
            me._addAddImgListener();//����������ͼƬ����
            me._addRemoveImgListenter();//ɾ������ͼƬ����
            me._addScalePicListenter();//������Ŵ���
            me._addClearSelectionListenter();//������ѡ��״̬����

            me._originalColorSelect(options.drawBrushColor);//��ʼ����ɫѡ��
            me._originalBrushSelect(options.drawBrushSize);//��ʼ������ѡ��
            me._clearSelection();//���ѡ��״̬
        },

        originalState:function (options) {
            var me = this;

            me.brushWidth = options.drawBrushSize;//ͬ�����ʴ�ϸ
            me.brushColor = options.drawBrushColor;//ͬ��������ɫ

            context.lineWidth = me.brushWidth;//��ʼ���ʴ�С
            context.strokeStyle = me.brushColor;//��ʼ������ɫ
            context.fillStyle = "transparent";//��ʼ����������ɫ
            context.lineCap = "round";//ȥ�����
            context.fill();
        },
